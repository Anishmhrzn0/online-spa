...
import { Calendar, User, Phone, Mail, Droplets, Thermometer, Flower, Settings } from 'lucide-react';
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {services.map((service) => (
                <div
                  key={service.id}
                  className={`border-2 rounded-xl p-4 cursor-pointer transition-all ${selectedService === service.id
